...
class EventController extends Controller
{
    ...
    */
    ...
    {
        $events = Event::where('vendor_id',$request->user()->id)->orderBy('id','desc')->paginate(20);
        return view('dashboard.vendor.event.index', compact('events'));
    }
    ...
    */
    public function show(Request $request,$id)
    {
        ...
        return view('dashboard.vendor.event.show',compact('event'));
    }
    ...
    */
    ...
    {
        $event = Event::whereId($id)->first();
        return view('dashboard.vendor.event.edit',compact('event'));
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect()->route('vendor.events')->with('success','Event has been updated successfully');
    }
    ...
    */
    public function destroy(Request $request,$id)
    {
        ...
        return redirect()->route('vendor.events')->with('success','Event has been deleted successfully');
    }
}
